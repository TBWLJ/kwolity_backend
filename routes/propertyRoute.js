...
router.post('/create', verifyToken, verifyTokenAndAdmin, upload.array('images', 5), createProperty);
...
// Get property by ID route - put this last to avoid route conflicts
